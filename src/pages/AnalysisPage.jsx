...
export default function AnalysisPage({bills}){
 ...
 const funcs=[
  ...
  {icon:AlertTriangle,title:'9. Alertas automáticos',value:`${(diag.alertas||[]).length} alerta(s)`,text:(diag.alertas||[])[0]||'O Nemotron não sinalizou alertas específicos nesta fatura.'},
  {icon:BrainCircuit,title:'10. Diagnóstico Nemotron',value:current.confianca?.geral?`Confiança ${current.confianca.geral}`:'Analisado',text:diag.resumo||'O diagnóstico será gerado pela IA a partir dos dados identificados.'}
 ]
