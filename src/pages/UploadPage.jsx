...
export default function UploadPage({onSaved}){
 ...
 async function run(){
  ...
  try{
    ...
    setState('ai');setProgress(72);setMsg('O sistema está identificando consumo, demanda, Ponta, Fora de Ponta, TE, TUSD, cobranças e histórico...')
 ...
 return <div className="space-y-5 page-enter">
  ...
  <section className="upload-hero animate-enter"><div className="hero-grid"/><div className="relative z-10"><div className="hero-kicker"><WandSparkles size={14}/>Nova análise detalhada</div><h1>Envie uma conta de energia</h1><p>O sistema extrai o texto do PDF, usa OCR quando necessário e organiza os dados energéticos e financeiros para o dashboard institucional.</p><div className="upload-trust"><span><ShieldCheck size={15}/>PDF original não é armazenado</span><span><CheckCircle2 size={15}/>kWh e kW separados</span><span><Sparkles size={15}/>Conferência antes de salvar</span></div></div></section>
