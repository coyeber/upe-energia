...
export default function App(){
 ...
 useEffect(()=>{checkGemini().then(h=>{setHealth(h);setStatus(h.apiKeyConfigured?'ready':'error')}).catch(()=>setStatus('error'))},[])
