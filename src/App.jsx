...
function BootScreen(){
 ...
 const stage=progress<32?'Energizando interface':progress<62?'Sincronizando indicadores':progress<84?'Conectando inteligência Gemini':'Finalizando ambiente seguro'
 return <div className="boot-screen boot-electric">
   ...
   <div className="boot-card electric-boot-card">
     <div className="boot-brand-lockup"><img src="/upe-logo.png" alt="UPE"/><span/><div><strong>UPE Energia</strong><small>Centro de Inteligência Energética</small></div></div>
     ...
     <h1>Inteligência que transforma energia em decisão.</h1>
     ...
     <div className="boot-tech-row"><span><ShieldCheck size={14}/> Ambiente seguro</span><span><Cpu size={14}/> Gemini conectado via backend</span><span><Activity size={14}/> Indicadores sincronizados</span></div>
   </div>
 </div>
}
