...
export default function ReviewForm({data,onSave,fileName,provider,model}){
 ...
 return <section className="card review-card animate-enter">
  <div className="review-head"><div><div className="label text-[#123b73]">Conferência obrigatória</div><h2 className="section-title">Revise os dados antes de alimentar o dashboard</h2><p className="section-subtitle">O sistema organiza a fatura, mas a confirmação humana mantém a base confiável para análises acadêmicas.</p></div><span className="review-badge"><ShieldCheck size={15}/>Análise + validação</span></div>
